            ...
            <section id="buttons">
              <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/rxjs/4.0.6/rx.testing.js"></script> -->
                <div id="controls" class="control-container">
                  ...
                  <table>
                  #https://upload.wikimedia.org/wikipedia/vi/c/cd/Logo-hcmut.svg
                  <tr><a href="#"><img id="logo" src="file:///C:/Users/Khai%20Nguyen/Google%20Drive/LVTN-NguyenLeHoangKhai/LVTN-%20NguyenLeHoangKhai/Sources%20Code/ESP32CAM%20Robot%20Car/esp32cam-robot-05/logo1.svg"></a>
                  ...
                  <tr>
                      ...
                      <td align="center"><button class="button button4" id="auto_off" onclick="fetch(document.location.origin+'/control?var=auto_off&val=1');">AUTO OFF</button></td></tr>
...
void robot_setup()
{
    ...
    ledcAttachPin(AUTO_ON, 9);
    ledcSetup(9, 2000, 8);      
    

     // Motor uses auto_off function
    ledcAttachPin(AUTO_OFF, 10);
    ledcSetup(10, 2000, 8);      
