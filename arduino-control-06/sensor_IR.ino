void sensor_ir(){
  ...
  if ((digitalRead(L_S) == 1)&&(digitalRead(R_S) == 1)){forward();delay(10);Serial.println("forward");}// đi tiến 
  ...
  if ((digitalRead(L_S) == 0)&&(digitalRead(R_S) == 0)){turn_180();delay(10); Serial.println("turn_180");} // quay xe
}
